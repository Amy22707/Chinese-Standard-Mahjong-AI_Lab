...
def _parse_args():
    ...
    parser.add_argument('--target_kl', type=float, default=0.02,
                        help='PPO early-stop KL threshold: stop epoch when approx KL > 1.5x this (default: 0.02)')
    parser.add_argument('--opp_historical_prob', type=float, default=0.8,
                        help='Probability of opponents using a random historical model for diversity (default: 0.8)')
...
if __name__ == '__main__':
    ...
    config = {
        ...
        'opp_historical_prob'  : args.opp_historical_prob,
        # PPO / GAE
        'gamma'                : args.gamma,
        'lambda'               : args.lam,
        'clip'                 : args.clip,

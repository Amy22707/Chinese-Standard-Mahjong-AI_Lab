...
DEFAULT_CONFIG = {
    ...
    'target_kl'             : 0.02,    # PPO early-stop KL threshold (stop epoch if approx KL > 1.5x this)
    'opp_historical_prob'   : 0.8,     # probability of using a historical (non-latest) model for opponents
